...
public:
    ...
    void createNextGeneration(int requiredPopulation);  // Cambiado para recibir población requerida
...
private:
    ...
    const float MUTATION_RATE = 0.05f;    // Probabilidad de mutación por atributo
    const float SELECTION_RATE = 0.5f;    // Porcentaje de elite a conservar
    ...
    // Selecciona padre para reproduccion del tipo requerido
